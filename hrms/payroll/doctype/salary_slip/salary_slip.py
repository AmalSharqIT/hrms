...
class SalarySlip(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		working_hours_salary: DF.Currency
	...
	def pull_sal_struct(self):
		...
		make_salary_slip(
			...
			self,
			ignore_permissions=self.flags.ignore_permissions if self.flags.ignore_permissions else False,
		)
