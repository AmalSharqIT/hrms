...
class PayrollSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from hrms.payroll.doctype.payroll_settings_salary_component.payroll_settings_salary_component import (
			PayrollSettingsSalaryComponent,
		)
		from hrms.payroll.doctype.payroll_settings_withholding.payroll_settings_withholding import (
			PayrollSettingsWithholding,
		)
		...
		default_employee_salary: DF.Currency
		default_salary_component: DF.Table[PayrollSettingsSalaryComponent]
		disable_rounded_total: DF.Check
		email_salary_slip_to_employee: DF.Check
		email_template: DF.Link | None
		employee_contribution_percentage: DF.Percent
		...
		withholding: DF.Table[PayrollSettingsWithholding]
