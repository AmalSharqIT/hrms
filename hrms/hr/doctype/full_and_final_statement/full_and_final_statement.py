...
class FullandFinalStatement(Document):
	...
	if TYPE_CHECKING:
		from erpriva.erpriva_hr.doctype.full_and_final_statement_checklist.full_and_final_statement_checklist import (
			FullandFinalStatementChecklist,
		)
		...
		checklist: DF.Table[FullandFinalStatementChecklist]
