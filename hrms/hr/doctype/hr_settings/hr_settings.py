...
class HRSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from hrms.hr.doctype.hr_settings_loan_amounts.hr_settings_loan_amounts import HRSettingsLoanAmounts
		from hrms.hr.doctype.hr_settings_overtime.hr_settings_overtime import HRSettingsOvertime

		advance_limit_percent_of_salary: DF.Percent
		...
		blocked_guarantors_employee_group: DF.Link | None
		check_vacancies: DF.Check
		days_after_joining_to_apply_for_loan: DF.Int
		default_employment_type: DF.Link | None
		default_number_of_installments: DF.Int
		...
		loan_amount_limits: DF.Table[HRSettingsLoanAmounts]
		overtime_settings: DF.Table[HRSettingsOvertime]
